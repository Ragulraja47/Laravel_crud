        ...
        <tbody>
          @foreach ($data as $d)
            <tr>
               ...
               <td class="text-center"> {{ $d->dept}} </td>
               <td class="text-center"><button type="button" value="{{$d->id}}" class="btn btn-primary btnuseredit">Edit</button> &emsp14;
               <button type="button" value="{{$d->id}}" class="btn btn-danger btnuserdelete">Delete</button></td>
            </tr>
        @endforeach
        </tbody>
      </table>
